...
mejor_modelo <- function(fichero, ini_datos, fin_datos, meses_valid){
  ...
  param_rf <- mejor_random_forest(fichero, ini_datos, fin_datos, meses_valid, k)
  ...
  #Saco el XGBoost:
  param_xgb <- mejor_xgboost(fichero, ini_datos, fin_datos, meses_valid, k)
  ...
  param_glmn <- mejor_glmnet(fichero, ini_datos, fin_datos, meses_valid, k)
...
mejor_modelo_final <- function(fichero, ini_datos, fin_datos, meses_valid, k){
  require(openxlsx)
  require(dplyr)
  require(tibbletime)
  require(timetk) 
