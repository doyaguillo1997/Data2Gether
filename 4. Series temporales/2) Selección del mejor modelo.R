...
for(fichero in ficheros){
  MejorModelo <- mejor_modelo(fichero, "2006-01-01", "2021-04-01", 16)
  save(MejorModelo, 
...
for(fichero in ficheros){
  MejorModelo <- mejor_ensamblado(fichero, "2006-01-01", "2021-04-01", 16)
  save(MejorModelo, 
       file = paste0("../Mejores modelos de cada tipo/", 
                     substr(fichero, 1, nchar(fichero) - 5), ".RData"))
}
...
for(fichero in ficheros){
  MejorModelo <- mejor_modelo_final(fichero, "2006-01-01", "2021-04-01", 16)
  save(MejorModelo, 
